...
(function () {
    ...
    function laser(hand) {
        ...
        // The purpose of this is to simulate the joint not found fallback method.
        var jointName = hand === 'right' ? 'FakeRightHandJointName' : 'FakeLeftHandJointName'; //'RightHand' : 'LeftHand';
